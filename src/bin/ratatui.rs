...
async fn main(_spawner: Spawner) {
    ...
    let backend_config = EmbeddedBackendConfig {
        ...
        flush_callback: Box::new(move |disp: &mut st7735_lcd::ST7735<embedded_hal_bus::spi::ExclusiveDevice<Spi<'_, embassy_stm32::mode::Blocking>, Output<'_>, embedded_hal_bus::spi::NoDelay>, Output<'_>, DummyPin>| {
            disp.clear(Rgb565::BLACK).unwrap();
        }),
        ..Default::default()
    };
